...
class ConvNeXtTrainingConfig:
    ...
    checkpoint_dir: str = str(current_dir / "checkpoints_convnext_base_tinyimagenet")
    resume_from_checkpoint: Optional[str] = None
    metrics_filename: str = "metrics.csv"
    model_drop_path_rate: float = 0.2
...
class ConvNeXtTrainer:
    def __init__(self, model, train_loader, val_loader, config: ConvNeXtTrainingConfig):
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.config.epochs + 1):
            ...
            raw_val_loss, raw_val_accuracy = self.evaluate(self.model)
            ema_val_loss = ""
            ema_val_accuracy = ""
            ...
            if self.config.use_ema:
                ...
                ema_val_loss, ema_val_accuracy = self.evaluate(self.model)
    ...
    def save_checkpoint(self, filename, epoch, raw_val_accuracy, ema_val_accuracy, is_best):
...
def main():
    ...
    print("=" * 70)
    print("ConvNeXt-Base Training on Tiny ImageNet")
    print("=" * 70)
    ...
    training_config = ConvNeXtTrainingConfig(seed=seed)
