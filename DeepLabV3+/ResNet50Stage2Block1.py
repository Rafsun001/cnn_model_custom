...
class ResNet50Stage2Block1(nn.Module):
    def __init__(self):
        super().__init__()

        self.conv1 = nn.Conv2d(256, 128, kernel_size=1, stride=2, bias=False)
        ...
        self.shortcut_conv = nn.Conv2d(256, 512, kernel_size=1, stride=2, bias=False)
