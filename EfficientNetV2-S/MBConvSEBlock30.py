...
class MBConvSEBlock30(nn.Module):
    def __init__(self, drop_path_rate=0.0):
        ...
        self.expand_bn = nn.BatchNorm2d(1536, eps=1e-3)
        ...
        self.depthwise_bn = nn.BatchNorm2d(1536, eps=1e-3)
        ...
        self.project_bn = nn.BatchNorm2d(256, eps=1e-3)
