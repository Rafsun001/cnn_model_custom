...
class HeadDetectP4(nn.Module):
    """
    YOLO26-style P4 detection head.
    ...
    def __init__(self):
        ...
        # In official Detect, hidden sizes are calculated from the first detection
        # feature channel. For this educational split, we keep the same values
        # across P3/P4/P5.
    ...
    def bias_init(self, stride=16, image_size=640):
